 ...
 */
function generatepresss_include_style_script() {
	// Style
	wp_enqueue_style( 'generate-bootstrap', get_template_directory_uri().'/assets/custom/libs/bootstrap/css/bootstrap.min.css', false,rand(),'all' );
	wp_enqueue_style( 'generate-custom', get_template_directory_uri().'/assets/custom/css/style.css', false,rand(),'all' );
	// Script
	wp_enqueue_script( 'generate-bootstrap', get_template_directory_uri().'/assets/custom/libs/bootstrap/js/bootstrap.min.js', array(),true,rand() );
	wp_enqueue_script( 'generate-custom', get_template_directory_uri().'/assets/custom/js/style.js', array(),true,rand() );
}
add_action( 'wp_enqueue_scripts', 'generatepresss_include_style_script' );
